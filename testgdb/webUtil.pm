...
sub pageHead {
	...
	print
	  ...
	  qq{<!--[if lt IE 7]><style type="text/css">#menuh{float:none;}body{behavior:url($testgdb::util::webloc/web/csshover.htc);font-size:100%;}#menuh ul li{float:left;width:100%;}#menuh a{height:1%;font:bold 0.7em/1.4em arial, sans-serif;}</style><![endif]-->\n},
	  qq{<link rel="stylesheet" type="text/css" href="$testgdb::util::webloc/web/main.css">\n},
	  qq{<script type="text/javascript" src="$testgdb::util::webloc/web/main.js"></script>\n},
	  qq{<script type="text/javascript" src="$testgdb::util::webloc/web/sorttable2.js"></script>\n},
	  qq{<script type="text/javascript" src="$testgdb::util::webloc/web/overlib_mini.js"></script><!-- overLIB (c) Erik Bosrup -->\n},
	  qq{</head>\n},
